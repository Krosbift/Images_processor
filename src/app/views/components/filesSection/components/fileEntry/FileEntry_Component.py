...
class FileEntryComponent(tk.Entry):
  ...
  def init_config(self):
    super().__init__(self.section, font=("Helvetica", 10), bg="#FFFFFF", fg="#111111", bd=2, relief="solid", borderwidth=1, state="readonly", textvariable=self.controller.path_route)
